...
function optionsframework_active_options(){
	...
	$options[] = array('name' => '用户名','id' => 'mbt_modia_username','desc' => '模板兔网站的用户名（个人中心 - 我的资料）','type' => 'text');
	$options[] = array('name' => '激活码','id' => 'mbt_modia_token','desc' => '模板兔网站的下载标识码（个人中心 - 下载清单）','type' => 'text');
	return $options;
}