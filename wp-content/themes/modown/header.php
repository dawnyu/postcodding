...
<header class="header">
  <div class="container clearfix">
    ...
    <ul class="nav-right">
      ...
      <li class="nav-login no"><a href="<?php echo get_permalink(MBThemes_page("/wxlogin"));?>" class="signin-loader"><i class="icon icon-user"></i><span>登录1</span></a><?php if(!_MBT('register')){?><b class="nav-line"></b><a href="<?php echo get_permalink(MBThemes_page("template/login.php"));?>?action=register" class="signup-loader"><span>注册</span></a><?php }?></li>
