...
$tips_6_4 = ' <span class="badge badge-radius badge-danger">6.4+</span>';
$tips_6_5 = ' <span class="badge badge-radius badge-danger">6.5+</span>';
$tips_6_6 = ' <span class="badge badge-radius badge-danger">6.6+</span>';
        ...
        array(
            ...
            'fields' => array(
                array(
                    ...
                    'default'    => 'RiPro主题,www.20su.cn,www.20su.cn',
                ),
                array(
                    'id'      => 'web_description',
                    'type'    => 'textarea',
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        //新增免登陆购买模式和全新付款方式弹窗，如此真诚的开发我们希望您能支持正版 感谢支持 www.20su.cn
        array(
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'default'    => '<a href="https://www.20su.cn/" target="_blank" rel="nofollow"><img src="' . get_template_directory_uri() . '/assets/images/hero/ads.jpg"></a>',
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'title'    => '底部版权信息',
            'subtitle' => '自定义版权信息',
            'default'  => '© 2018 &#x642c;&#x7801;&#x0077;&#x0077;&#x0077;&#x002e;&#x0061;&#x0062;&#x006e;&#x006d;&#x0061;&#x002e;&#x0063;&#x006f;&#x006d; - www.20su.cn &amp; WordPress Theme. All rights reserved',
        ),
  ...
  <br/>------授权错误会提示错误消息，成功则顶部显示-设置已保存。</br></br><i class="fa fa-heart" style=" color: red; "></i> PS：承蒙您对本主题的喜爱，我们愿向小三一样，做大哥的女人，做大哥网站中最想日的一个。开发者不易，我们真诚的希望和感谢每一个真心建站运营的朋友能支持日系列的正版主题，更好的更用心的等你来调教。如此强大好用的日系列主题，包含支付等重要安全功能，我们希望用户一定要重视自己的数据安全，不要相信所谓破解等盗版，盗版无利不起早，一切以安全为己任。共同维护创造国内健康的WordPress使用环境。开发者Mr.Hcx敬上。</br></br>授权注意事项：中途更换域名，更换HTTPS，更换网站标题等，都需要后台主题设置重新保存一下设置和授权，请修正数据库中的域名，保证你绑定的域名和你WP后台，常规设置里面的域名一致。其次，中途从不同版本的数据库SQL操作迁移数据库，导入导出都会促使编码格式不对，个例情况，如果有个别弹出授权提示，请检查授权信息不要有空格，重新填写正确的授权保存即可，数据无损。',
    'fields'      => array(
        ...
        array(
            ...
            'type'  => 'text',
            'title' => '会员ID',
            'after' => '<p><b><font color="red">注意不要有空格 </font></b>会员购买授权中心 <a href="https://www.20su.cn/" target="_blank"> &#x642c;&#x7801;&#x0077;&#x0077;&#x0077;&#x002e;&#x0061;&#x0062;&#x006e;&#x006d;&#x0061;&#x002e;&#x0063;&#x006f;&#x006d;</a></p>',
        ),
        array(
            'id'    => 'ripro_vip_code',
            'type'  => 'text',
