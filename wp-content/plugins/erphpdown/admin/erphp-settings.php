<?php
 ...
 if(isset($_POST['Submit'])) {
    ...
    update_option('ice_ali_money_ref2', trim($_POST['ice_ali_money_ref2']));
 	...
 	update_option('ice_tips_free', trim($_POST['ice_tips_free']));
 	...
 	<form method="post" action="<?php echo admin_url('admin.php?page='.plugin_basename(__FILE__)); ?>">
 		<table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="ice_ali_money_ref2" name="ice_ali_money_ref2" value="<?php echo $ice_ali_money_ref2; ?>" class="regular-text"/>% 
 			...
 			<tr>
 				...
 				<td>
 					<input type="number" id="ice_ali_money_author" name="ice_ali_money_author" value="<?php echo $ice_ali_money_author; ?>"  class="regular-text"/>%
 			...
 			<tr>
 				...
 				<td>
 					<input type="number" id="ice_ali_money_checkin" name="ice_ali_money_checkin" value="<?php echo $ice_ali_money_checkin; ?>"  class="regular-text"/> <?php echo $erphpdown_payname;?> （请输入一个整数）
 				</td>
 			</tr>
 			<tr>
 				<th valign="top">新注册赠送</th>
 				<td>
 					<input type="number" id="ice_ali_money_new" name="ice_ali_money_new" value="<?php echo $ice_ali_money_new; ?>" class="regular-text"/> <?php echo $erphpdown_payname;?> （请输入一个整数，赠送新用户）
 				</td>
 			</tr>
 			<tr>
 				<th valign="top">推广注册奖励</th>
 				<td>
 					<input type="number" id="ice_ali_money_reg" name="ice_ali_money_reg" value="<?php echo $ice_ali_money_reg; ?>" class="regular-text"/> <?php echo $erphpdown_payname;?> （请输入一个整数，奖励推广人）
 				</td>
 			</tr>
 			<tr>
 				<th valign="top">提现规则 *</th>
 				<td>
 					<input type="number" id="ice_ali_money_limit" name="ice_ali_money_limit" value="<?php echo $ice_ali_money_limit; ?>" required="required" class="regular-text"/> <?php echo $erphpdown_payname;?>以上方可提现 （请输入一个整数）
 				</td>
 			</tr>
 			<tr>
 			...
 			<tr>
 				...
 				<td>
 					<textarea id="ice_tips" name="ice_tips" placeholder="" rows="5" cols="70"><?php echo $ice_tips; ?></textarea>
 				</td>
 			</tr>
 			<tr>
 				<th valign="top">免费购买说明</th>
 				<td>
 					<textarea id="ice_tips_free" name="ice_tips_free" placeholder="" rows="5" cols="70"><?php echo $ice_tips_free; ?></textarea>
 				</td>
 			</tr>
 			<tr>
 			...
 			<tr>
 				...
 				<td>
 					<input type="checkbox" id="erphp_mycred" name="erphp_mycred" value="yes" <?php if($erphp_mycred == 'yes') echo 'checked'; ?> /> （需安装<a href="https://wordpress.org/plugins/mycred/" target="_blank">mycred插件</a>与<a href="" target="_blank">erphpdown集成mycred插件</a>） 兑换比例：
 		...
 		<p class="submit">
 			...
 			<div >技术支持：mobantu.com <a href="http://www.65kr.com/6658.html" target="_blank">使用教程>></a></div>
 		</p>      
 	</form>
 	<script>
