<?php
 ...
 <div class="wrap">
 	...
 	<form method="post" action="<?php echo admin_url('admin.php?page='.plugin_basename(__FILE__)); ?>">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					设置地址：<a href="https://pay.weixin.qq.com/index.php/account/api_cert" target="_blank">https://pay.weixin.qq.com/index.php/account/api_cert </a>，建议为32位字符串<br>设置教程：<a href="" target="_blank"></a>
				</td>
			</tr>
			<tr>
		...
		<div>详情请看：<a href="http://www.65kr.com/8080.html" target="_blank" rel="nofollow">http://www.65kr.com/8080.html</a></div>
		<table class="form-table">
			<tr>
		...
		<div>关于此接口的安全稳定性，请使用者自行把握，我们只提供技术集成服务，接口申请地址：<a href="https://admin.xunhupay.com/sign-up/451.html" target="_blank" rel="nofollow">点击查看</a></div>
		<table class="form-table">
			<tr>
				<th valign="top">appid</th>
				<td>
		...
		<div>关于此接口的安全稳定性，请使用者自行把握，我们只提供技术集成服务，接口申请地址：<a href="https://codepay.fateqq.com/i/520753" target="_blank" rel="nofollow">点击查看</a></div>
		<table class="form-table">
			<tr>
