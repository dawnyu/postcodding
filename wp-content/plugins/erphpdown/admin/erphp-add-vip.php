...
<table class="form-table">
	...
	<tr>
		...
		<td><input type="radio" id="userType" name="userType" value="10"/>终身会员 --- <?php echo $ciphp_life_price.get_option('ice_name_alipay')?> <br /><input type="radio" id="userType" name="userType" value="9"/>包年会员 --- <?php echo $ciphp_year_price.get_option('ice_name_alipay')?> <br /> <input
			...
			<input type="radio" id="userType" name="userType" value="7" checked />包月会员 --- <?php echo $ciphp_month_price.get_option('ice_name_alipay')?> <br />
			<input type="radio" id="userType" name="userType" value="6" checked />体验会员 --- <?php echo $ciphp_day_price.get_option('ice_name_alipay')?>
		</td>
	</tr>
	<tr>
